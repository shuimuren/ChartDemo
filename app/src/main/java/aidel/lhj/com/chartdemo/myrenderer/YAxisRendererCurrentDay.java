package aidel.lhj.com.chartdemo.myrenderer;
...
import aidel.lhj.com.chartdemo.MyApplication;
import aidel.lhj.com.chartdemo.R;
                ...
                if (text.contains("%")) {
                    if (text.contains("-")) {
                        if (Float.parseFloat(text.replaceAll("[^\\d.]", "")) == 0) {
                            text = text.replace("-", "");
                            mAxisLabelPaint.setColor(ContextCompat.getColor(MyApplication.getContext(), R.color.kline_text));
                        } else {
                            mAxisLabelPaint.setColor(ContextCompat.getColor(MyApplication.getContext(), R.color.text_green));
                        }
                    } else {
                        if (Float.parseFloat(text.replaceAll("[^\\d.]", "")) > 0) {
                            text = "+" + text;
                            mAxisLabelPaint.setColor(ContextCompat.getColor(MyApplication.getContext(), R.color.text_red));
                        }
                    }
                } else {
