...
import aidel.lhj.com.chartdemo.mychart.CombinedChartKline;
import aidel.lhj.com.chartdemo.mychart.MyTransformer;
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            if (dataSet.isDrawValuesEnabled()) {
                drawValue(c,
                        ...
                        xMax,
                        yMax,
                        ContextCompat.getColor(MyApplication.getContext(), R.color.kline_red));
                ...
                drawValue(c,
                        ...
                        xMin,
                        yMin,
                        ContextCompat.getColor(MyApplication.getContext(), R.color.kline_green));
